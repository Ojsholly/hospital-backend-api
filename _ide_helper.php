 ...
 */
     ...
     */ 
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::created($data, $message);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::badRequest($message);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::unauthorized($message);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::forbidden($message);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::notFound($message);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Routing\ResponseFactory::internalServerError($message);
        }
